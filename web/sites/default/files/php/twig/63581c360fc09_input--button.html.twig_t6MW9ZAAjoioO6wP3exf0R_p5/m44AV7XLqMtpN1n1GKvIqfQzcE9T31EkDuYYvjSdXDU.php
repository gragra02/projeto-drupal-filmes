...
/* themes/custom/filmes/templates/system/input--button.html.twig */
class __TwigTemplate_e36aee55db35ecb83b1305167748dcce extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    {
        $macros = $this->macros;
        $this->parent = $this->loadTemplate("input.html.twig", "themes/custom/filmes/templates/system/input--button.html.twig", 1);
...
($context["icon"] ?? null) && ($context["icon_position"] ?? null)) &&  !($context["icon_only"] ?? null))) ? (("icon-" . $this->sandbox->ensureToStringAllowed(($context["icon_position"] ?? null), 30, $this->source))) : (""))];
  ...
  ";
    ...
    {
        return "themes/custom/filmes/templates/system/input--button.html.twig";
    }
...
#}
  {% block input %}{% apply spaceless %}
    ...
    {% endif %}
    {{ children }}
  {% endapply %}{% endblock %}", "themes/custom/filmes/templates/system/input--button.html.twig", "C:\\xampp\\htdocs\\site_de_teste\\web\\themes\\custom\\filmes\\templates\\system\\input--button.html.twig");
    }
